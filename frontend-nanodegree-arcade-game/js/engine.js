...
var Engine = (global => {
    ...
    let main = () => {
        ...
        if (player.win) {
            createMessage({
                ...
                title: 'you win',
                contentColor: 'white',
                content: 'you win, press enter to restart game'
            });
        }
            ...
            createMessage({
                ...
                title: 'game over!!',
                contentColor: 'white',
                content: 'you lose, press enter to restart game'
            });
        }
    ...
    let createMessage = payload => {
        ...
        ctx.fillRect(90, 200, 380, 150);
        ctx.fillStyle = payload.titleColor;
        ctx.fillText(payload.title, 180, 250);
        ctx.font = '17pt "VT323"';
        ctx.fillStyle = payload.contentColor;
        ctx.fillText(payload.content, 105, 300);
    }
